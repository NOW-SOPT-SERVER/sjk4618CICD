#!/bin/bash
BUILD_PATH=$(ls /home/ubuntu/app/springFirstSeminar-0.0.1-SNAPSHOT.jar)
...
GREEN_APPLICATION=$GREEN_PROFILE-springFirstSeminar.jar
...
BLUE_PID=$(pgrep -f $BLUE_PROFILE-springFirstSeminar.jar)
